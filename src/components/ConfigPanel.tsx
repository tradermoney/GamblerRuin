  ...
  return (
    <div className={`${styles.configPanel} ${className}`}>
      ...
      <div className={styles.formGrid}>
        ...
        {/* Row 3 */}
        <div className={styles.inputGroup}>
          <label className={styles.label}>投注比例</label>
          <input
            type="number"
            min="0.01"
            max="1"
        ...
        <div className={styles.inputGroup}>
          <label className={styles.label}>止损金额</label>
          <input
            type="number"
            min="0"
        ...
        <div className={styles.inputGroup}>
          <label className={styles.label}>止盈金额</label>
          <input
            type="number"
            min="0"
        ...
        <div className={styles.inputGroup}>
          <label className={styles.label}>最小赌注</label>
          <input
            type="number"
            min="1"
        ...
        {/* Row 4 */}
        <div className={styles.inputGroup}>
          <label className={styles.label}>最大赌注</label>
          <input
            type="number"
        ...
        <div className={styles.inputGroup}>
          <label className={styles.label}>连败重置次数</label>
          <input
            type="number"
            min="1"
        ...
        <div className={styles.inputGroup}>
          <label className={styles.label}>手续费率</label>
          <input
            type="number"
            min="0"
            max="1"
